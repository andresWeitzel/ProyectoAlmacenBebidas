...
fanta, etc). De los productos nos interesa saber su identificador (cada uno 
tiene uno distinto), cantidad de litros, precio y marca.
...
si tiene o no alguna promoción (si la tiene tendrá un descuento del 10% en el
precio).
...
Puedes usar un main para probar las funcionalidades (añade productos, 
